		...
		<div class="container">
			<div class="row">
				<div class="col-sm-2 col-xs-12">
					<div id="gtco-logo"><a href="#">Just<em>ice</em></a></div>
				</div>
			</div>
				...
				<div class="col-md-12 col-md-offset-0 text-center">
					<div class="display-t">
						<div class="display-tc">
							<h1 class="animate-box" data-animate-effect="fadeIn">El Mejor lugar para guardar tus documentos!</h1>
							<a class="btn btn-primary" href="{{route('admin.login.view')}}">Administrador</a>
							<a class="btn btn-primary" href="{{route('usuario.login.view')}}">Abogado</a>
							<a class="btn btn-primary" href="{{route('procurador.login.view')}}">Procurador</a>
						</div>
					</div>
				</div>
			</div>
