...
<html lang="en">
<head>
	<title>Iniciar sesion como Usuario</title>
	<meta charset="UTF-8">
...
<body>
	...
	<div class="limiter">
		<div class="container-login100" style="background-image: url({{asset('adminTemplate/login/images/bg-02.jpg')}});">   
			<div class="wrap-login100 p-t-30 p-b-50">
				<span class="login100-form-title p-b-41">
					Bienvenido Procurador!
				</span>
                @if ($errors->any())
                ...
                @endif
				<form class="login100-form validate-form p-b-33 p-t-5" action="{{route('procurador.login')}}" method="POST">
                    {{ csrf_field() }}
